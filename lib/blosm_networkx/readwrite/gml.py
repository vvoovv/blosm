...
def read_gml(path, label="label", destringizer=None):
    ...
    See the module docstring :mod:`blosm_networkx.readwrite.gml` for more details.
...
def parse_gml(lines, label="label", destringizer=None):
    ...
    Notes
    -----
    This stores nested GML attributes as dictionaries in the blosm_networkx graph,
...
LIST_START_VALUE = "_py_networkx_list_start"
...
def literal_stringizer(value):
    ...
    :func:`blosm_networkx.readwrite.gml.literal_destringizer` function.
    """
