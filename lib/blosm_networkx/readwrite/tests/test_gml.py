...
from lib.blosm_networkx.readwrite.gml import literal_destringizer, literal_stringizer
...
"""
    ...
    def test_tuplelabels(self, stringizer):
        # https://github.com/blosm_networkx/blosm_networkx/pull/1048
  ...
  edge [
    ...
    def test_quotes(self):
        # https://github.com/blosm_networkx/blosm_networkx/issues/1061
        ...
        assert result == dedent(
            ...
            graph [
              node [
                id 0
                label "n1"
                properties "_py_networkx_list_start"
                properties "element"
              ]
            ]
        """
