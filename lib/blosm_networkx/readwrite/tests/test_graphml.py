...
from lib.blosm_networkx.readwrite.graphml import GraphMLWriter
from lib.blosm_networkx.utils import edges_equal, nodes_equal
...
class TestWriteGraphML(BaseGraphML):
    ...
    def test_write_generate_edge_id_from_attribute(self):
        ...
        assert nodes_equal(G.nodes(), H.nodes())
        assert edges_equal(G.edges(), H.edges())
        # blosm_networkx adds explicit edge "id" from file as attribute
    ...
    def test_multigraph_write_generate_edge_id_from_attribute(self):
        ...
        # blosm_networkx uses edge_ids as keys in multigraphs if no key
