...
gexf.xsd" version="1.2">
  <meta lastmodifieddate="{time.strftime('%Y-%m-%d')}">
    <creator>blosm_networkx {nx.__version__}</creator>
  </meta>
 ...
 version="1.2">
  ...
  <graph defaultedgetype="undirected" mode="static" name="">
    ...
    def test_specials(self):
        ...
        assert H.nodes[1]["py_networkx_key"] == "a"
        assert H.nodes[2]["py_networkx_key"] == "b"
        assert H.nodes[3]["py_networkx_key"] == "c"
    ...
    def test_simple_list(self):
        ...
        fh.seek(0)
        H = nx.read_gexf(fh, node_type=int)
        assert H.nodes[1]["py_networkx_key"] == list_value
