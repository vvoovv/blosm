...
def read_graphml(path, node_type=str, edge_key_type=int, force_multigraph=False):
    ...
    there is no "key" attribute a default blosm_networkx multigraph edge key
    will be provided.
...
class GraphMLReader(GraphML):
    """Read a GraphML document.  Produces blosm_networkx graph objects."""
    ...
    def add_edge(self, G, edge_element, graphml_keys):
        ...
        # blosm_networkx uses them as keys in multigraphs too if no key
