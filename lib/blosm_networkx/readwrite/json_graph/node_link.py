...
def node_link_data(
    ...
    *,
    ...
    source : string
        A string that provides the 'source' attribute name for storing blosm_networkx-internal graph data.
    target : string
        A string that provides the 'target' attribute name for storing blosm_networkx-internal graph data.
    name : string
        A string that provides the 'name' attribute name for storing blosm_networkx-internal graph data.
    key : string
        A string that provides the 'key' attribute name for storing blosm_networkx-internal graph data.
    link : string
        A string that provides the 'link' attribute name for storing blosm_networkx-internal graph data.
    ...
    The attribute names for storing blosm_networkx-internal graph data can
