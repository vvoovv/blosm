...
def adjacency_data(G, attrs=_attrs):
    ...
    attrs : dict
        ...
        values provide the attribute names for storing blosm_networkx-internal graph
    ...
    Examples
    --------
    >>> from lib.blosm_networkx.readwrite import json_graph
    >>> G = nx.Graph([(1, 2)])
    ...
    The default value of attrs will be changed in a future release of blosm_networkx.
