...
from lib.blosm_networkx.classes import Graph
from lib.blosm_networkx.exception import NetworkXError
from lib.blosm_networkx.utils import nodes_or_number, pairwise
...
def circulant_graph(n, offsets, create_using=None):
    ...
    Returns
    -------
    blosm_networkx Graph of type create_using
...
def dorogovtsev_goltsev_mendes_graph(n, create_using=None):
    ...
    create_using : blosm_networkx Graph, optional
...
def empty_graph(n=0, create_using=None, default=Graph):
    ...
    if create_using is None:
        ...
        raise TypeError("create_using is not a valid blosm_networkx graph type or instance")
    else:
        # create_using is a blosm_networkx style Graph
        create_using.clear()
        G = create_using
