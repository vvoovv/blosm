...
#:
#:     import gzip
#:     from lib.blosm_networkx.generators.atlas import graph_atlas_g
#:     from lib.blosm_networkx.readwrite.edgelist import write_edgelist
#:
...
ATLAS_FILE = importlib.resources.files("lib.blosm_networkx.generators") / "atlas.dat.gz"
...
def graph_atlas(i):
    ...
    -------
    list
        A list of :class:`~blosm_networkx.Graph` objects, the one at index *i*
...
def graph_atlas_g():
    ...
    Although the blosm_networkx atlas functions match the order of graphs
