...
In Blender, Pandas, scipy and pygraphviz are not available and excluded here.
...
def to_networkx_graph(data, create_using=None, multigraph_input=False):
    ...
    data : object to be converted
        ...
        Current known types are:
         ...
         generator of edges
         Pandas DataFrame (row per edge)        In Blender not aivailable
         2D numpy array
         scipy sparse array                     In Blender not aivailable
         pygraphviz agraph                      In Blender not aivailable
