...
:func:`is_isomorphic <blosm_networkx.algorithms.isomorphism.is_isomorphic>`
function.
...
subclassed, and the
:meth:`semantic_feasibility <blosm_networkx.algorithms.isomorphism.GraphMatcher.semantic_feasibility>`
...
:func:`line_graph <blosm_networkx.generators.line.line_graph>`. For
...
--------
:meth:`semantic_feasibility <blosm_networkx.algorithms.isomorphism.GraphMatcher.semantic_feasibility>`
:meth:`syntactic_feasibility <blosm_networkx.algorithms.isomorphism.GraphMatcher.syntactic_feasibility>`
...
class GraphMatcher:
    ...
    def __init__(self, G1, G2):
        ...
        Parameters
        ----------
        G1,G2: blosm_networkx Graph or MultiGraph instances.
