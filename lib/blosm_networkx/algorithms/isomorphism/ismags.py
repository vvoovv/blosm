...
class ISMAGS:
    ...
    edge_equality: collections.abc.Callable
        ...
        It's signature looks like this:
        ``f(graph1: blosm_networkx.Graph, edge1, graph2: blosm_networkx.Graph, edge2) -> bool``.
    ...
    def __init__(self, graph, subgraph, node_match=None, edge_match=None, cache=None):
        ...
        node_match: collections.abc.Callable or None
            ...
            :func:`~blosm_networkx.algorithms.isomorphism.categorical_node_match` and
            friends.
        ...
        edge_match: collections.abc.Callable or None
            ...
            :func:`~blosm_networkx.algorithms.isomorphism.categorical_edge_match` and
            friends.
    ...
    def find_isomorphisms(self, symmetry=True):
        ...
        """
        # The blosm_networkx VF2 algorithm is slightly funny in when it yields an
