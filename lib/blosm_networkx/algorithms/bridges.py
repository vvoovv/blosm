...
def bridges(G, root=None):
    ...
    using the :func:`blosm_networkx.chain_decomposition` function.
    ...
    same as the :func:`blosm_networkx.chain_decomposition` function,
...
def has_bridges(G, root=None):
    ...
    Notes
    -----
    This implementation uses the :func:`blosm_networkx.bridges` function, so
