...
from lib.blosm_networkx import NetworkXError
from lib.blosm_networkx.algorithms.community.community_utils import is_partition
from lib.blosm_networkx.utils.decorators import argmap
...
def _require_partition(G, partition):
    ...
    Raises :exc:`blosm_networkx.NetworkXError` if the partition is not valid.
    ...
    order)::
        ...
        Traceback (most recent call last):
          ...
        blosm_networkx.exception.NetworkXError: `partition` is not a valid partition of the nodes of G
