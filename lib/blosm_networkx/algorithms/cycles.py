...
def recursive_simple_cycles(G):
    ...
    It appears in blosm_networkx for pedagogical value.
...
def find_cycle(G, source=None, orientation=None):
    ...
    Traceback (most recent call last):
        ...
    blosm_networkx.exception.py_networkxNoCycle: No cycle found.
    ...
    for start_node in G.nbunch_iter(source):
        ...
        assert len(cycle) == 0
        raise nx.exception.py_networkxNoCycle("No cycle found.")
