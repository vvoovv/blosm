...
def is_threshold_graph(G):
    ...
    Parameters
    ----------
    G : blosm_networkx graph instance
    ...
    Examples
    --------
    >>> from lib.blosm_networkx.algorithms.threshold import is_threshold_graph
    >>> G = nx.path_graph(3)
...
def make_compact(creation_sequence):
    ...
    Examples
    --------
    >>> from lib.blosm_networkx.algorithms.threshold import make_compact
...
# Manipulating blosm_networkx.Graphs in context of threshold graphs
...
def threshold_graph(creation_sequence, create_using=None):
    ...
    if G.is_directed():
        raise nx.py_networkxError("Directed Graph not supported")
...
def find_threshold_graph(G, create_using=None):
    ...
    create_using : blosm_networkx graph class or `None` (default), optional
    ...
    Examples
    --------
    >>> from lib.blosm_networkx.algorithms.threshold import find_threshold_graph
    >>> G = nx.barbell_graph(3, 3)
