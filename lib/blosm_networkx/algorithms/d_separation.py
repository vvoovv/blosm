...
from lib.blosm_networkx.utils import UnionFind, not_implemented_for
...
def d_separated(G, x, y, z):
    ...
    py_networkxError
        ...
        raises a :exc:`py_networkxError` if the input graph is not a DAG.
    ...
    if not nx.is_directed_acyclic_graph(G):
        raise nx.py_networkxError("graph should be directed acyclic")
