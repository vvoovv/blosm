...
from lib.blosm_networkx.exception import NetworkXNoPath
...
def edge_disjoint_paths(
    ...
    and undirected graphs, and can use all flow algorithms from lib.blosm_networkx flow
    package.
    ...
    # blosm_networkx return a residual network.
    kwargs = {
        "capacity": "capacity",
        "residual": residual,
        "cutoff": cutoff,
