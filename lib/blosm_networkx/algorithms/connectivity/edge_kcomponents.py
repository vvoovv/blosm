...
def bridge_components(G):
    ...
    Parameters
    ----------
    G : blosm_networkx undirected graph
    ...
    >>> from lib.blosm_networkx.algorithms.connectivity.edge_kcomponents import bridge_components
...
class EdgeComponentAuxGraph:
    ...
    >>> import itertools as it
    >>> from lib.blosm_networkx.utils import pairwise
    >>> from lib.blosm_networkx.algorithms.connectivity import EdgeComponentAuxGraph
