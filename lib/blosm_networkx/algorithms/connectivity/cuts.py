...
# cut algorithms.
from lib.blosm_networkx.algorithms.flow import build_residual_network, edmonds_karp
...
def minimum_st_edge_cut(G, s, t, flow_func=None, auxiliary=None, residual=None):
    ...
    auxiliary : blosm_networkx DiGraph
    ...
    flow_func : function
        ...
        that follows blosm_networkx conventions (see :meth:`maximum_flow` for
    ...
    residual : blosm_networkx DiGraph
    ...
    Examples
    --------
    This function is not imported in the base blosm_networkx namespace, so you
    have to explicitly import it from the connectivity package:

    >>> from lib.blosm_networkx.algorithms.connectivity import minimum_st_edge_cut
    ...
    data structures that blosm_networkx uses in the computation: the
    ...
    >>> from lib.blosm_networkx.algorithms.connectivity import build_auxiliary_edge_connectivity
    >>> H = build_auxiliary_edge_connectivity(G)
    >>> # And the function for building the residual network from the
    >>> # flow package
    >>> from lib.blosm_networkx.algorithms.flow import build_residual_network
    ...
    >>> from lib.blosm_networkx.algorithms.flow import shortest_augmenting_path
...
def minimum_st_node_cut(G, s, t, flow_func=None, auxiliary=None, residual=None):
    ...
    >>> from lib.blosm_networkx.algorithms.connectivity import minimum_st_node_cut
    ...
    >>> # You also have to explicitly import the function for
    >>> # building the auxiliary digraph from the connectivity package
    >>> from lib.blosm_networkx.algorithms.connectivity import build_auxiliary_node_connectivity
