# See https://github.com/blosm_networkx/blosm_networkx/pull/1474
...
def all_triplets(G):
    ...
    .. deprecated:: 3.3
       ...
       all_triplets is deprecated and will be removed in blosm_networkx version 3.5.
...
def triad_type(G):
    ...
    ----------
    G : digraph
       A blosm_networkx DiGraph with 3 nodes
    ...
    """
    if not is_triad(G):
        raise nx.py_networkxAlgorithmError("G is not a triad (order-3 DiGraph)")
...
def random_triad(G, seed=None):
    ...
    -------
    G2 : subgraph
       A randomly selected triad (order-3 blosm_networkx DiGraph)
    ...
    warnings.warn(
        (
            "\n\nrandom_triad is deprecated and will be removed in blosm_networkx v3.5.\n"
