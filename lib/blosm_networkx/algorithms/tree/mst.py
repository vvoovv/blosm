...
from lib.blosm_networkx.utils import UnionFind, not_implemented_for, py_random_state
...
def minimum_spanning_tree(G, weight="weight", algorithm="kruskal", ignore_nan=False):
    ...
    See :mod:`blosm_networkx.tree.recognition` for more detailed definitions.
...
def random_spanning_tree(G, weight=None, *, multiplicative=True, seed=None):
    ...
    def find_node(merged_nodes, node):
        ...
        This cannot be replaced by the standard blosm_networkx union_find since that
    ...
    def spanning_tree_total_weight(G, weight):
        ...
        if multiplicative:
            ...
            #    is assumed to be 1, which is conveniently built into blosm_networkx already,
