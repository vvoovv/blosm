...
from lib.blosm_networkx.algorithms.flow.utils import build_residual_network
...
def dinitz(G, s, t, capacity="capacity", residual=None, value_only=False, cutoff=None):
    ...
    blosm_networkx uses for defining residual networks.
    ...
    Examples
    --------
    >>> from lib.blosm_networkx.algorithms.flow import dinitz

    The functions that implement flow algorithms and output a residual
    network, such as this one, are not imported to the base blosm_networkx
...
def dinitz_impl(G, s, t, capacity, residual, cutoff):
    ...
    while flow_value < cutoff:
        ...
        if this_flow * 2 > INF:
            raise nx.py_networkxUnbounded("Infinite capacity path, flow unbounded above.")
