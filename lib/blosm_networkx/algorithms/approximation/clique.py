...
from lib.blosm_networkx.algorithms.approximation import ramsey
...
def large_clique_size(G):
    ...
    *d* is the maximum degree.
    ...
    :func:`blosm_networkx.algorithms.approximation.clique.max_clique`
        A function that returns an approximate maximum clique with a
        guarantee on the approximation ratio.

    :mod:`blosm_networkx.algorithms.clique`
