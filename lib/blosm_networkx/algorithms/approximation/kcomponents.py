...
from lib.blosm_networkx.algorithms.approximation import local_node_connectivity
...
def k_components(G, min_density=0.95):
    ...
    >>> from lib.blosm_networkx.algorithms import approximation as apxa
    >>> G = nx.petersen_graph()
...
class _AntiGraph(nx.Graph):
    ...
    an instance of this class with some of blosm_networkx functions. In this
