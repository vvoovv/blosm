...
from lib.blosm_networkx.algorithms.shortest_paths.weighted import _weight_function
from lib.blosm_networkx.utils import not_implemented_for, pairwise
...
def is_simple_path(G, nodes):
    ...
    *edge paths*. There is a bijection between node paths and edge
    ...
    like the following::
        ...
        >>> from lib.blosm_networkx.utils import pairwise
        >>> nodes = [0, 1, 2, 3]
    ...
    # py_networkxPointlessConcept here.
    if len(nodes) == 0:
        return False
...
def all_simple_paths(G, source, target, cutoff=None):
    ...
    :func:`blosm_networkx.utils.pairwise` helper function::
...
def _bidirectional_shortest_path(
    ...
    path implementation at blosm_networkx.algorithms.unweighted
...
def _bidirectional_dijkstra(
    ...
    shortest path implementation at blosm_networkx.algorithms.weighted
