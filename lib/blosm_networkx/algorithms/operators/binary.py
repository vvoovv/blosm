...
def union(G, H, rename=()):
    ...
    --------
    compose
    :func:`~blosm_networkx.Graph.update`
    disjoint_union
...
def intersection(G, H):
    ...
    ----------
    G,H : graph
       A blosm_networkx graph. G and H can have different node sets but must be both graphs or both multigraphs.
...
def difference(G, H):
    ...
    ----------
    G,H : graph
       A blosm_networkx graph. G and H must have the same node sets.
