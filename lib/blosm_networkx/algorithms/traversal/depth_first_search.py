...
def dfs_edges(G, source=None, depth_limit=None):
    ...
    (see `~blosm_networkx.algorithms.traversal.edgedfs.edge_dfs`).
    ...
    dfs_postorder_nodes
    dfs_labeled_edges
    :func:`~blosm_networkx.algorithms.traversal.edgedfs.edge_dfs`
    :func:`~blosm_networkx.algorithms.traversal.breadth_first_search.bfs_edges`
