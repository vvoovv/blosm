    ...
    if sort_neighbors is not None:
        ...
        warnings.warn(
            (
                ...
                "in blosm_networkx 3.4, use the neighbors parameter instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
...
def bfs_edges(G, source, reverse=False, depth_limit=None, sort_neighbors=None):
    ...
    :func:`~blosm_networkx.algorithms.traversal.edgebfs.edge_bfs`. The difference
    ...
    --------
    bfs_tree
    :func:`~blosm_networkx.algorithms.traversal.depth_first_search.dfs_edges`
    :func:`~blosm_networkx.algorithms.traversal.edgebfs.edge_bfs`
