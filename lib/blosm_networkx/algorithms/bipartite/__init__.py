...
The bipartite algorithms are not imported into the blosm_networkx namespace
at the top level so the easiest way to use them is with:

>>> from lib.blosm_networkx.algorithms import bipartite

blosm_networkx does not have a custom bipartite graph class but the Graph()
...
in blosm_networkx is to use a node attribute named `bipartite` with values 0 or 1 to
...
Many algorithms of the bipartite module of blosm_networkx require, as an argument, a
...
raise an :exc:`AmbiguousSolution <blosm_networkx.AmbiguousSolution>`
Exception if the input graph for
:func:`bipartite.sets <blosm_networkx.algorithms.bipartite.basic.sets>`
is disconnected.
...
All bipartite graph generators in blosm_networkx build bipartite graphs with the
...
:mod:`Generators <blosm_networkx.algorithms.bipartite.generators>`.

"""

from lib.blosm_networkx.algorithms.bipartite.basic import *
from lib.blosm_networkx.algorithms.bipartite.centrality import *
from lib.blosm_networkx.algorithms.bipartite.cluster import *
from lib.blosm_networkx.algorithms.bipartite.edgelist import *
from lib.blosm_networkx.algorithms.bipartite.projection import *
from lib.blosm_networkx.algorithms.bipartite.redundancy import *
from lib.blosm_networkx.algorithms.bipartite.generators import *
from lib.blosm_networkx.algorithms.bipartite.extendability import *
