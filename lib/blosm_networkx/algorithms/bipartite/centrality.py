...
def degree_centrality(G, nodes):
    ...
    :func:`~blosm_networkx.algorithms.bipartite.basic.sets`
    :func:`~blosm_networkx.algorithms.bipartite.basic.is_bipartite`

    Notes
    -----
    The nodes input parameter must contain all nodes in one bipartite node set,
    but the dictionary returned contains all nodes from both bipartite node
    sets. See :mod:`bipartite documentation <blosm_networkx.algorithms.bipartite>`
