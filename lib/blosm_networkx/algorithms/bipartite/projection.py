...
from lib.blosm_networkx.exception import NetworkXAlgorithmError
...
def projected_graph(B, nodes, multigraph=False):
    ...
    Returns
    -------
    Graph : blosm_networkx graph or multigraph
    ...
    See :mod:`bipartite documentation <blosm_networkx.algorithms.bipartite>`
    for further details on how bipartite graphs are handled in blosm_networkx.
...
def weighted_projected_graph(B, nodes, ratio=False):
    ...
    if n_top < 1:
        raise py_networkxAlgorithmError(
