...
********************
Read and write blosm_networkx graphs as bipartite edge lists.
...
from lib.blosm_networkx.utils import not_implemented_for, open_file
...
def write_edgelist(G, path, comments="#", delimiter=" ", data=True, encoding="utf-8"):
    ...
    ----------
    G : Graph
       A blosm_networkx bipartite graph
    path : file or string
...
def parse_edgelist(
    ...
    delimiter : string, optional
       Separator for node labels
    create_using: blosm_networkx graph container, optional
       Use given blosm_networkx graph for holding nodes or edges.
...
def read_edgelist(
    ...
    create_using : Graph container, optional,
       Use specified container to build graph.  The default is blosm_networkx.Graph,
       an undirected graph.
    ...
    -------
    G : graph
       A blosm_networkx Graph or other type specified with create_using
