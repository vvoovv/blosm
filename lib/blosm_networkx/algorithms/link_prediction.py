...
def _apply_prediction(G, func, ebunch=None):
    ...
    `G` is an instance of :class:`blosm_networkx.Graph`.
...
def resource_allocation_index(G, ebunch=None):
    ...
    ----------
    G : graph
        A blosm_networkx undirected graph.
...
def adamic_adar_index(G, ebunch=None):
    ...
    ----------
    G : graph
        blosm_networkx undirected graph.
...
def common_neighbor_centrality(G, ebunch=None, alpha=0.8):
    ...
    if alpha == 1:
        ...
        def predict(u, v):
            if u == v:
                raise nx.py_networkxAlgorithmError("Self links are not supported")
...
def within_inter_cluster(G, ebunch=None, delta=0.001, community="community"):
    ...
    """
    if delta <= 0:
        raise nx.py_networkxAlgorithmError("Delta must be greater than zero")
...
def _community(G, u, community):
    ...
    try:
        ...
        raise nx.py_networkxAlgorithmError("No community information") from err
