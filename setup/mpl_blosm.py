...
def setup(app, osm):
    ...
    app.argParserExtra.add_argument("--gnStreets", action='store_true', help="Create streets and intersections for GN", default=False)
    ...
    gnStreets = getattr(app, "gnStreets", False)
    
    # managers
    
    buildings = wayManager = gnStreetsManager = None
    ...
    if gnStreets:
        gnStreetsManager = RoadPolygonsManager(osm, app)
        gnStreetsManager.addAction(StreetsForGN())
